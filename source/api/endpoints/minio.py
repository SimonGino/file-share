...
async def upload_file(file: UploadFile = File(...)):
    try:
        ...
        presigned_url = minio_client.get_file_preview_url(get_settings().MINIO_BUCKET_NAME, file.filename)
...
async def get_file_info(filename: str):
    try:
        ...
        presigned_url = minio_client.get_file_preview_url(bucket_name, filename)
